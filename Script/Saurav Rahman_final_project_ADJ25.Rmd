...
#Summary (National): Wage theft is still a big problem in the United States. According to the Wage and Hour Complince Acition data, Texas has the most wage theft cases with 45,983 individual cases, while Florida has the highest number of total violations at 1,185,054 violations across 29,046 cases. Missouri ranks 13th for the number of cases, with 7,871 violations, and 25th for total violations with 131,087. Subway has the most wage theft cases filed against it, with 1,359 cases. Wells Fargo has committed the most violations, with a total of 530,002 violations. Walmart affected 88,278 workers with its violations. The Puerto Rico Department of Corrections had to pay the highest amount in back wages: $39,950,933.10. The restaurant and hotel industry has the most violations. Over the last 10 years, the number of wage theft cases and violations has gone down, showing that things may be improving, especially with laws like the Family and Medical Leave Act (FMLA) and child labor laws.

#Project idea: Tracking Wage Theft in America
#Details: Create a interactive portal where people explore decade-long trends in wage theft by state, industry, employer and all other related information. 

#Story idea:
#1: Wage theft cases are going down—but why? 
An analysis of why wage theft is happening less often now and if that’s really a good sign.
#2:Workers in restaurants and hotels faces the most wage theft.
Why and how people in the food and hotel industry are the most likely to be affected by wage theft.
#3: Why Florida and Texas have the most wage theft?
An investigative look at why these two states have more wage theft than others.
#4: Big companies, big violations.
Subway, Wells Fargo and Walmart have broken wage laws many times and what has happened because of it.

#Summary (Missouri): In Missouri, George's Processing, Incorporated had the highest number of Wage & Hour Compliance violations, with 3,148 violations in 2 cases. This company also paid the highest back wages, amounting to $1,245,257.09 to 3,084 employees. The employer also violated the law against the highest number of employees in Missouri, affecting 3,147 workers. Missouri Vegetable Farm paid the highest civil money penalties of $384,626.61 for violations. The city of Saint Louis recorded the highest number of cases, violations, and affected employees in Missouri, with 1,487 cases, 25,019 violations, and 21,956 affected employees, repectivly. Over the past 10 years, Missouri has seen a decline in wage and hour violations, with a drop in cases from 318 in 2020 to just 6 in 2024. Missouri's average time to resolve a Wage & Hour Compliance case is 589 days, with a median time of 728 days (about two years). One case, involving Blue Springs Lawn & Garden, took 4,840 days—more than 13 years—to complete.
...
#2. Wage theft in Saint Louis the highest violations in Missouri"
...
#3. George's Processing leads Missouri in wage violations and back wages. 
A detailed story about George's Processing, Incorporated, the company with the most violations and highest back wages paid in Missouri, affecting over 3,000 employees.
...
Q11: Which indicators of Wage & Hour Compliance Action data have the highest total violations? 
...
Q12: How has the number of major indicators of Wage & Hour Compliance violations varied over the years?
...
Q14. How do the top five states that have done the highest violations in total vary in terms of total violations of Wage and Hour Compliance over the last 10 years?
#Answer: All five states have seen decreases in violations by 2024. Every state's total violation was below a thousand last year. Florida had the highest violations in 2017 with 117,685 and remained one of the top violators. Tennessee saw two spikes in violations: 266,410 in 2019 and 240,982 in 2021. Texas had high violations in the early years, especially in 2015 (83,727) and 2019 (163,653), then declined. California showed consistent mid-to-high violations with a peak in 2018 (89,522). Arkansas (AR) had a high violation in 2016 (456,237) but saw a decline afterward.
...
Q15. How have the states varied in terms of total violations of Wage and Hour Compliance over the last 10 years?
...
Q20. Which employer/business violated Hour and Wage Compliance against the highest number of employees in Missouri?
#Answer: George's Processing, Incorporated. A total of 3147 employees were affected by  George's Processing's violations of Hour and Wage Compliance, which is the highest number in  Missouri.
...
Q23. Which industry in Missouri experienced the highest number of cases, the highest number of violations, and the most affected employees according to the Wage & Hour Compliance violation data?
...
Q24. Which indicators of Wage & Hour Compliance Action data have the highest total violations in Missouri? 
...
Q32. Which employer in Missouri violated the Family and Medical Leave Act the most, and which industry tops the list for Family and Medical Leave Act violations?
...
Q33. Which employer in Missouri violated the Child Labor Act the most, and which industry and city top the list for Child Labor Act violations?
...
Q34. Which employer/business in Missouri violated all six major indicators of Wage and Hours Compliance?
#Answer: None.
